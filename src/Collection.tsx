...
function Collection({lang}:{lang:Lang}){
  return <main className="page collection-page">
    ...
    <section className="collection-intro">
      <div>
        <p className="eyebrow">SELECTED WRITINGS</p>
        <h2>{lang==='en'?'Words are another kind of space.':'文字，是另一种空间。'}</h2>
      </div>
    ...
    <section className="collection-feature">
      ...
      <div className="collection-feature-body">
        <div className="collection-feature-copy">
          <p className="collection-type">{lang==='en'?'ESSAY · PRINT':'文章 · 纸媒'}</p>
          <h2>虚拟世界侵入现实</h2>
        ...
        <div className="publication-card">
          <span className="publication-kicker">读库</span>
          <strong>2401</strong>
          <span className="publication-caption">P261—283<br/>虚拟世界侵入现实</span>
        </div>
      </div>
    </section>
    ...
    <section className="collection-section">
      ...
      <article className="collection-row featured-row">
        <span className="collection-row-no">01</span><div><p className="collection-row-type">{items[0].metaEn}</p><h4>{items[0].title}</h4><p className="collection-row-desc">{lang==='en'?items[0].descEn:items[0].descZh}</p></div><a href={readkuUrl} target="_blank" rel="noreferrer">{lang==='en'?'VIEW':'查看'} ↗</a>
      </article>
    </section>
    ...
    <section className="collection-section">
      ...
      <article className="collection-row featured-row">
        <span className="collection-row-no">01</span><div><p className="collection-row-type">{items[1].metaEn}</p><h4>{items[1].title}</h4><p className="collection-row-desc">{lang==='en'?items[1].descEn:items[1].descZh}</p><div className="collection-row-recognition">{lang==='en'?items[1].recognitionEn:items[1].recognitionZh}</div></div><span className="collection-row-muted">{lang==='en'?'LINK TO BE ADDED':'待补充直链'}</span>
      </article>
    ...
    <section className="collection-section">
      ...
      <article className="collection-row featured-row answer-row">
        <span className="collection-row-no">01</span><div><p className="collection-row-type">{items[2].metaEn}</p><h4>{items[2].title}</h4><p className="collection-row-desc">{lang==='en'?items[2].descEn:items[2].descZh}</p><div className="collection-row-recognition">{lang==='en'?items[2].recognitionEn:items[2].recognitionZh}</div></div><a href={zhihuUrl} target="_blank" rel="noreferrer">{lang==='en'?'READ':'查看'} ↗</a>
      </article>
